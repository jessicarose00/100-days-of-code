...
**Focus**: Review of multiple linear regression

**Progress**:
- reviewed MLR assumptions with a specific focus on multicollinearity
- learned about VIF as a way to identify presence of multicollinearity (applied using statsmodels)

**Thoughts**: Today was a review of linear model assumptions with a closer look at multicollinearity. I learned about variance inflation factors, and how multicollinearity impacts the model coefficients and standard errors.
